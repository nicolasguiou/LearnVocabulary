package core
{
	...
	public class CommunicationDataBase extends EventDispatcher
	{
		...
		//			
		//			// get the DataBase
		//			myDataBase = (DataBase.getInstance().getProperty(DataBase.getInstance().currentDB) as ArrayCollection);
		//			myDataBase = (myDataBase) ? myDataBase:new ArrayCollection();
		//			
		//			var len:int = myDataBase.length;
		//			var myWordVO:WordVO;
		//			for(var i:int = 0 ; i < len ; i++)
		//			{
		//				myWordVO = new WordVO();
		//				myWordVO.setWordVO(myDataBase[i]);
		//				
		//				if(myWordVO.category == category)
		//				{
		//					if(!onlyNew || (onlyNew && myWordVO.isNew))
		//					{
		//						myResult.addItem(myWordVO);
		//					}
		//				}
		//			}
		//			
		...
		//				myWordVO.setWordVO(myDataBase[i]);
		//				
		//				if(myWordVO.category && !myResult.contains(myWordVO.category))
		//				{
		//					myResult.addItem(myWordVO.category);
		//				}
		//			}
		//			
		//			return myResult;
